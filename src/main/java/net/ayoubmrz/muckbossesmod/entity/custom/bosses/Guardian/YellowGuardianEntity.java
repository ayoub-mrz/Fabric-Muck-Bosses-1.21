...
public class YellowGuardianEntity extends HostileEntity implements GeoEntity, GuardianEntity, BaseValues {

    private final AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

    private static final TrackedData<Boolean> IS_SHOOTING_LAZER = DataTracker.registerData(YellowGuardianEntity.class, TrackedDataHandlerRegistry.BOOLEAN);

    private static final TrackedData<Boolean> IS_SHOOTING_LIGHTNING = DataTracker.registerData(YellowGuardianEntity.class, TrackedDataHandlerRegistry.BOOLEAN);

    private static final TrackedData<Boolean> IS_LASER_SOUND_START = DataTracker.registerData(YellowGuardianEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    ...
    private final ServerBossBar bossBar = new ServerBossBar(Text.literal("Yellow Guardian"),
    ...
    private PlayState shootLightningPredicate(AnimationState<YellowGuardianEntity> event) {
    ...
    private PlayState shootLazerPredicate(AnimationState<YellowGuardianEntity> event) {
    ...
    private PlayState attackPredicate(AnimationState<YellowGuardianEntity> event) {
    ...
    private PlayState predicate(AnimationState<YellowGuardianEntity> animationState) {
