...
public class PurpleGuardianEntity extends HostileEntity implements GeoEntity, GuardianEntity, BaseValues {

    private final AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

    private static final TrackedData<Boolean> IS_SHOOTING_LAZER = DataTracker.registerData(PurpleGuardianEntity.class, TrackedDataHandlerRegistry.BOOLEAN);

    private static final TrackedData<Boolean> IS_SHOOTING_LIGHTNING = DataTracker.registerData(PurpleGuardianEntity.class, TrackedDataHandlerRegistry.BOOLEAN);

    private static final TrackedData<Boolean> IS_LASER_SOUND_START = DataTracker.registerData(PurpleGuardianEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    ...
    private final ServerBossBar bossBar = new ServerBossBar(Text.literal("Purple Guardian"),
            BossBar.Color.PURPLE, BossBar.Style.PROGRESS);

    public PurpleGuardianEntity(EntityType<? extends HostileEntity> entityType, World world) {
    ...
    private PlayState shootLightningPredicate(AnimationState<PurpleGuardianEntity> event) {
    ...
    private PlayState shootLazerPredicate(AnimationState<PurpleGuardianEntity> event) {
    ...
    private PlayState attackPredicate(AnimationState<PurpleGuardianEntity> event) {
    ...
    private PlayState predicate(AnimationState<PurpleGuardianEntity> animationState) {
