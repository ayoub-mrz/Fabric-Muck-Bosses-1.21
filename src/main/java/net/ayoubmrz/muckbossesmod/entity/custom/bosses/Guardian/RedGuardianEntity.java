...
public class RedGuardianEntity extends HostileEntity implements GeoEntity, GuardianEntity, BaseValues {

    private final AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

    private static final TrackedData<Boolean> IS_SHOOTING_LAZER = DataTracker.registerData(RedGuardianEntity.class, TrackedDataHandlerRegistry.BOOLEAN);

    private static final TrackedData<Boolean> IS_SHOOTING_LIGHTNING = DataTracker.registerData(RedGuardianEntity.class, TrackedDataHandlerRegistry.BOOLEAN);

    private static final TrackedData<Boolean> IS_LASER_SOUND_START = DataTracker.registerData(RedGuardianEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    ...
    private final ServerBossBar bossBar = new ServerBossBar(Text.literal("Red Guardian"),
            BossBar.Color.PURPLE, BossBar.Style.PROGRESS);

    public RedGuardianEntity(EntityType<? extends HostileEntity> entityType, World world) {
    ...
    private PlayState shootLightningPredicate(AnimationState<RedGuardianEntity> event) {
    ...
    private PlayState shootLazerPredicate(AnimationState<RedGuardianEntity> event) {
    ...
    private PlayState attackPredicate(AnimationState<RedGuardianEntity> event) {
    ...
    private PlayState predicate(AnimationState<RedGuardianEntity> animationState) {
