...
public class WhiteGuardianEntity extends HostileEntity implements GeoEntity, GuardianEntity, BaseValues {

    private final AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

    private static final TrackedData<Boolean> IS_SHOOTING_LAZER = DataTracker.registerData(WhiteGuardianEntity.class, TrackedDataHandlerRegistry.BOOLEAN);

    private static final TrackedData<Boolean> IS_SHOOTING_LIGHTNING = DataTracker.registerData(WhiteGuardianEntity.class, TrackedDataHandlerRegistry.BOOLEAN);

    private static final TrackedData<Boolean> IS_LASER_SOUND_START = DataTracker.registerData(WhiteGuardianEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    ...
    private PlayState shootLightningPredicate(AnimationState<WhiteGuardianEntity> event) {
    ...
    private PlayState shootLazerPredicate(AnimationState<WhiteGuardianEntity> event) {
