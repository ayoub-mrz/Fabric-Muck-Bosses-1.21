...
public class WhiteGuardianRenderer extends GeoEntityRenderer<WhiteGuardianEntity> {

    public WhiteGuardianRenderer(EntityRendererFactory.Context renderManager) {
        super(renderManager, new WhiteGuardianModel<>());
    }

    @Override
    public Identifier getTextureLocation(WhiteGuardianEntity animatable) {
    ...
    public void scaleModelForRender(float widthScale, float heightScale, MatrixStack poseStack,
                                    WhiteGuardianEntity animatable, BakedGeoModel model, boolean isReRender, float partialTick,
