...
public class GronkBladeProjectileModel extends EntityModel<GronkBladeProjectileEntity> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData gronk_blade = modelPartData.addChild("gronk_blade", ModelPartBuilder.create(), ModelTransform.of(-1.5F, 14.0F, 0.0F, 0.0F, 0.0F, -1.5708F));

        ModelPartData blade = gronk_blade.addChild("blade", ModelPartBuilder.create().uv(0, 2).cuboid(-9.75F, 0.25F, -0.25F, 22.0F, 1.0F, 0.25F, new Dilation(0.0F))
                ...
                .uv(0, 4).cuboid(-9.75F, 3.25F, -0.25F, 19.0F, 1.0F, 0.25F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
