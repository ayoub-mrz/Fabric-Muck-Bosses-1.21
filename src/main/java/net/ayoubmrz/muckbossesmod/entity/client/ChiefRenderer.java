...
public class ChiefRenderer extends GeoEntityRenderer<ChiefEntity> {

    public ChiefRenderer(EntityRendererFactory.Context renderManager) {
        super(renderManager, new ChiefModel<>());
    }

    @Override
    public Identifier getTextureLocation(ChiefEntity animatable) {
    ...
    public void scaleModelForRender(float widthScale, float heightScale, MatrixStack poseStack,
                                    ChiefEntity animatable, BakedGeoModel model, boolean isReRender, float partialTick,
